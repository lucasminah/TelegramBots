...
public abstract class SSLConnectionSocketFactoryAbstract extends SSLConnectionSocketFactory {

    protected Proxy.Type proxyType;

    protected SSLConnectionSocketFactoryAbstract(final SSLContext sslContext) {
